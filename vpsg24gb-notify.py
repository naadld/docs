...
✅ <i>Live system event notification recorded.</i>"""
    ...
    try:
        with urllib.request.urlopen(req) as resp:
            ...
            if data.get("ok"):
                print(f"✅ Notification sent to Topic 3: {action_title} ({target_name})")
...
if __name__ == "__main__":
    if len(sys.argv) >= 3:
        ...
        print("Usage: python3 vpsg24gb-notify.py <Action> <Target> [Detail]")
